...
Phone: +27 (0)12 345-6789`;
        ...
        // Previous Events Handler
        document.querySelector('.previous-events-link').addEventListener('click', function(e) {
            e.preventDefault();
            // This would normally navigate to a separate page or show a modal
            alert('Previous Events page would be loaded here. This could contain a comprehensive list of past community gatherings, cultural celebrations, workshops, and traditional ceremonies.');
        });
